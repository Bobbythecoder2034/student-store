...
const SingleProduct = ({product}) =>
{
        ...
        return(
                ...
                <NavLink className="product flex flex-col items-center border-3 rounded-2xl p-3 m-2 mb-3 shadow-lg text-center dark:bg-gray-800 bg-white" id={product.slug} to={`/products/${product._id}`} >
